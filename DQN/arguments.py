...
def get_args():
    ...
    parse.add_argument("--env_name", type=str, default="Pong-v0", help="The environment")
    parse.add_argument("--batch_size", type= int, default= 64, help="The batch size of the data we train from")
    parse.add_argument("--initializer", type=str, default="xavier", help= "Method of weight initialization")
    ...
    parse.add_argument('--gamma', type=float, default=0.8, help='the discount factor i.e. gamma')
    ...
    parse.add_argument("--epsilon_start", type=float, default=0.9, help="starting epsilon")
    parse.add_argument("--epsilon_end", type=float, default=0.05, help="ending epsilon")
    parse.add_argument("--epsilon_decay", type=float, default=200, help="epsilon decay parameter")
    # implementation related arguments
    parse.add_argument("--clip_grads", action='store_true', help="perform gradient clipping")
    parse.add_argument("--clip_error", action='store_true', help="perform error clipping")
